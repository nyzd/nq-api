...
@extend_schema_view(
    list=extend_schema(
        ...
        parameters=[OpenApiParameter("surah_id", OpenApiTypes.UUID, OpenApiParameter.QUERY)]
    ),
...
class AyahViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ayah_fields = ['id', 'surah', 'number', 'sajdah', 'is_bismillah', 'bismillah_text', 'creator', 'length']
